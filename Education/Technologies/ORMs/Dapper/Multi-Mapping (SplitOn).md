...
---
### Суть (The "What")
**Multi-Mapping** — это механизм библиотеки [[Dapper]], позволяющий преобразовать одну плоскую строку (row), полученную в результате выполнения [[SQL]]-запроса с `JOIN`, в несколько связанных независимых [[00_MOC|C#]]-объектов.
