...
По умолчанию ссылочные типы (`class`) в [[Education/Languages/CSharp/00_MOC|C#]] сравниваются по ссылочной идентичности (адресу в управляемой куче). В [[DDD (Domain-Driven Design)||DDD]] логика сравнения сущностей должна базироваться **исключительно на их идентификаторах**.
