...
3.  **[[DDD]] (Domain-Driven Design):** Когда правила являются частью Ubiquitous Language (Единого языка). Классы называются так, как говорят аналитики (`OverdueDebtSpecification`).
